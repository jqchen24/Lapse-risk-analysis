...
########################################################
logReg <- glm(churn ~ CONTACTS + TENURE + TRANS12X + SALES12X + LINES12X + indseg0 + Customer_Size + INVSOLFLG + mro_decile + contract_group, data = accounts_train, family = binomial)
